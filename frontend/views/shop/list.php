    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href="<?=\yii\helpers\Url::to(['shop/detail','id'=>$list->id])?>"><img src="/images/goods1.jpg" alt="" /></a></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['shop/detail','id'=>$list->id])?>"><?=$list->name?></a></dt>
                        <dd><strong>特价：￥<?=$list->market_price?></strong></dd>
                        <dd><a href="<?=\yii\helpers\Url::to(['shop/detail','id'=>$list->id])?>"><em>已有<?=$list->stock?>人评价</em></a></dt>
                    </dl>
                </li>
