                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li class="cur">
                                <a  href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?='http://admin.yii2shop.com'.$img->path?>',largeimage: '<?='http://admin.yii2shop.com'.$img->path?>'}"><img src="<?='http://admin.yii2shop.com'.$img->path?>"></a>
                            </li>
                            <?php endforeach;?>
<!--                            <li>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有<?=$goods->stock?>人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
                <form action="<?=\yii\helpers\Url::to(['addcart'])?>" method="get" class="choose">
                <ul>
