    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href="<?=\yii\helpers\Url::to(['shop/detail','id'=>$model->id])?>"><img src="<?=$model->logo?>" alt="" /></a></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['shop/detail','id'=>$model->id])?>"><?=$model->name?></a></dt>
                        <dd><strong>特价：￥<?=$model->market_price?></strong></dd>
                        <dd><a href="<?=\yii\helpers\Url::to(['shop/detail','id'=>$model->id])?>"><em>已有<?=$model->stock?>人评价</em></a></dt>
                    </dl>
                </li>
