...
?>
<div>
    <a href="<?=\yii\helpers\Url::to(['article-category/add'])?>"  class="btn btn-default"><span class="glyphicon glyphicon-plus"></span></a>
</div><br>
<table class="table table-bordered table-responsive table-hover">
    ...
    <?php foreach ($articlecategorys as $articlecategory):?>
        <tr data_id="<?=$articlecategory->id?>">
            <td><?=$articlecategory->id?></td>
            <td><?=$articlecategory->name?></td>
            <td><?=$articlecategory->intro?></td>
            <td><?=$articlecategory->sort?></td>
            <td><?=$articlecategory->status?'显示':'隐藏'?></td>
            <td><a href="<?=\yii\helpers\Url::to(['article-category/edit','id'=>$articlecategory->id])?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span></a>
